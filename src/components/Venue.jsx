    ...
    return (
        ...
        <div className="Venue-container">
            ...
            <div className="Pakistani-reception-details">
                ...
                <p>A Pakistani reception will take place the following day, May 23, at the Weston Hills Country Club. Cocktails and hors d'ouevres begin at 5 p.m., with the reception to follow in the adjacent ballroom.</p>
            </div>
        </div>
        </>
    )
