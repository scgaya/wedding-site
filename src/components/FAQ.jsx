            ...
            <div className="FAQ-details">
                ...
                <div className="FAQ-row">
                    ...
                    <p>We've reserved a block of rooms at X hotel in Weston, FL. When you make a reservation,
                        ...
                        also welcome to stay anywhere in the Miami/Ft. Lauderdale area!
                    </p>
                </div>
                <hr width="90%" size="1" />
                <div className="FAQ-row">
                    <h2>Getting Around</h2>
                    <p>There is a considerable distance between the venue for Friday and the venue for Saturday & Sunday, so for guests 
